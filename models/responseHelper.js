...
//     console.log("filter parameters at the response helper", filterParameters);
    ...
    return {
      ...
      filterparameters: {
        ...
        major: filterParameters.major,
        minGPA: filterParameters.minGPA,
        maxGPA: filterParameters.maxGPA,
      },
    };
  }
}
